...
/**
 * Template Name: v2 / Services / Consultancy
...
wp_enqueue_style('_2x-css-template-services-consultancy', sprintf('%s/2x/assets/css/template-services-consultancy.css', get_stylesheet_directory_uri()), ['_2x-css-bootstrap'], time());
...
<div class="bootstrap-container services consultancy">
