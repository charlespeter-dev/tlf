...
/**
 * Template Name: v2 / Services / Optimization
...
wp_enqueue_style('_2x-css-template-services-optimization', sprintf('%s/2x/assets/css/template-services-optimization.css', get_stylesheet_directory_uri()), ['_2x-css-bootstrap'], time());
...
<div class="bootstrap-container services optimization">
