...
wp_enqueue_style('_2x-css-template-customers', sprintf('%s/2x/assets/css/template-customers.css', get_stylesheet_directory_uri()), ['_2x-css-bootstrap'], time());
